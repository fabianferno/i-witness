    ...
    return (
        <div className="w-full max-w-5xl space-y-6">
            <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold text-zinc-100">Recent PIRLs</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {RECENT_PIRLS.map((pirl) => (
                    <Link href={`/verify/${pirl.cid}`} key={pirl.id}>
                        <Card className="bg-zinc-900/30 border-zinc-800 hover:bg-zinc-900/50 transition-all cursor-pointer overflow-hidden group">
                                ...
                                <div className="relative aspect-[4/3] overflow-hidden">
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-3">
                                        <div className="flex justify-between items-end">
                                            <div>
                                                <p className="text-xs text-zinc-400 font-mono">{pirl.timestamp}</p>
                                                <p className="text-xs text-zinc-500 font-mono truncate w-24">{pirl.cid.slice(0, 8)}...</p>
                                            </div>
                                            <div className="text-right">
                                                <p className="text-[10px] text-zinc-400 uppercase">Liveness Score</p>
